...
// ) extends React.Component {
  ...
  //   const _passwordPrompt = !!user.passwordPrompt;
  //   console.log('_passwordPrompt is:', _passwordPrompt);
    // console.log('user in Home is:', user.passwordPrompt);
//     if (!firstProduct || !products ) return null;
//     if (_passwordPrompt) {
//       return (
//         <div>
