...
class AccountInformation extends React.Component {
  ...
  render() {
    ...
    if(!user || !user.id) return <h1 className='header'>Sign in to edit your account information.</h1>;
    return (
      <div id='style'>
        <h1 className='header'>Manage Account Info</h1>
...
export default connect(mapState, mapDispatch)(AccountInformation);
